...
class MyNotes {
  ...
  editNote(e) {
    ...
    console.log('thisNote.data("state")', thisNote.data("state"))
  ...
  updateNote(e) {
    ...
    $.ajax({
      ...
      url: wuniverseData.root_url + '/wp-json/wp/v2/note/' + thisNote.data('id'),
      type: 'POST',
      data: ourUpdatedPost,
      success: (response) => {
        this.makeNoteReadOnly(thisNote)
  ...
  createNote(e) {
    ...
    $.ajax({
      ...
      url: wuniverseData.root_url + '/wp-json/wp/v2/note/',
      type: 'POST',
      data: ourNewPost,
      success: (response) => {
